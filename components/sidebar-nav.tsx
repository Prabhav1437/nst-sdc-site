  ...
  return (
    <>
      <motion.div
        ...
        className="fixed left-8 top-1/2 z-[2000] hidden -translate-y-1/2 lg:flex"
      >
      ...
      <motion.nav
        ...
        className={clsx(
          'fixed left-8 top-1/3 hidden w-28 -translate-y-1/3 lg:flex z-[2000]',
      ...
      <motion.div
        ...
        className={clsx(
          'fixed left-0 right-0 top-0 z-[2000] flex items-center justify-between border-b px-4 py-3 backdrop-blur-xl lg:hidden',
          isDark
